...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==========================================
    const animarContador = (elementoId: string, valorFinal: number) => 
        {
    ...
    // ==========================================
    const btnComida = document.querySelector('.btn-food') as HTMLButtonElement | null;
    const btnAgua = document.querySelector('.btn-water') as HTMLButtonElement | null;
